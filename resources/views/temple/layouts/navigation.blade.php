<aside class="sidebar" id="templeSidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('temple.receipts.index') }}"
            class="nav-link {{ request()->routeIs('temple.receipts.*') ? 'nav-link--active' : '' }}">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round">
        ...
        <a href="{{ route('temple.receipt-printing.index') }}"
            class="nav-link {{ request()->routeIs('temple.receipt-printing.*') ? 'nav-link--active' : '' }}">
            <span class="nav-icon">
                <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round"
                    stroke-linejoin="round">
        ...
        <div class="nav-dropdown {{ request()->routeIs('temple.reports.*') ? 'nav-dropdown--active' : '' }}">
            ...
            <button type="button" class="nav-link nav-dropdown-toggle" onclick="toggleReportsDropdown()">
                ...
                <svg class="dropdown-arrow" id="reportsArrow" width="16" height="16" viewBox="0 0 24 24"
            ...
            <div class="nav-dropdown-menu {{ request()->routeIs('temple.reports.*') ? 'is-open' : '' }}"
                id="reportsDropdown">
        ...
        {{-- Settings Dropdown --}}
        <div
            class="nav-dropdown {{ request()->routeIs('temple.settings.*') || request()->routeIs('temple.profile.*') ? 'nav-dropdown--active' : '' }}">

            <button type="button" class="nav-link nav-dropdown-toggle" onclick="toggleSettingsDropdown()">
                ...
                <svg class="dropdown-arrow" id="settingsArrow" width="16" height="16" viewBox="0 0 24 24"
                    fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                    stroke-linejoin="round">
                    <polyline points="6 9 12 15 18 9" />
                </svg>
            ...
            <div class="nav-dropdown-menu {{ request()->routeIs('temple.settings.*') || request()->routeIs('temple.profile.*') ? 'is-open' : '' }}"
                id="settingsDropdown">

                {{-- Profile Update --}}
                @if (Route::has('temple.profile.edit'))
                    <a href="{{ route('temple.profile.edit') }}"
                        class="nav-dropdown-item {{ request()->routeIs('temple.profile.edit') ? 'active' : '' }}">
                ...
                {{-- General Settings --}}
                {{-- Change Password --}}
                @if (Route::has('temple.password.edit'))
                    <a href="{{ route('temple.password.edit') }}"
                        class="nav-dropdown-item {{ request()->routeIs('temple.password.edit') ? 'active' : '' }}">
