...
<head>
<meta charset="UTF-8">
<title>Daily Report — {{ \Carbon\Carbon::parse($date)->format('d M Y') }}</title>
<style>
...
<div class="header">
  <h1>Daily Temple Report</h1>
  <p>Date: {{ \Carbon\Carbon::parse($date)->format('d F Y') }}</p>
...
<table>
  ...
  <tbody>
    ...
    @empty
      <tr><td colspan="7" style="text-align:center; padding:20px; color:#888;">No transactions for this date.</td></tr>
    @endforelse
  </tbody>
  <tfoot>
    <tr>
